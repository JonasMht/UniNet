...
| `interop/` | one C++, one Python and one C# node in a realm, each checking the others' payloads and discovery headers; the C# node also checks where its handlers run | `./scripts/test-interop.sh` |
